                ...
                <div class="panel lock-box">
                    ...
                    <div class="row">
                        <form  class="form-inline" method="post">
                            ...
                            <?php
					include('conn.php');
					$sql="select * from tbl_flatmember where flat_member_id='$id'";
						...
						while($row=mysqli_fetch_assoc($res))
						{
                            ...
                            <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                <div class="text-left">
                                    ...
                                    <input id="Name" value="<?= $row['member_name']?>" type="text" placeholder="Enter Full Name" class="form-control" name="Name" />
                                </div>
                            </div>
                            <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                <div class="text-left">
                            ...
                            <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                <div class="text-left">
                                    ...
                                    <input id="signupInputContact" type="text" value="<?=$row['contact_no']?>" placeholder="" class="form-control" name="cono" />
                                </div>
                            </div>
                            <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                <div class="text-left">
...
<?php
			...
			//echo "Hello";
				...
				$sql="update tbl_flatmember set flat_id= '$fid' where flat_member_id=$id";
