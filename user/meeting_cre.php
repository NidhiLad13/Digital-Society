...
<head>
    ...
    <!--<img src="img/background/slide-bg2.png" alt="">-->
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
                                                Start Time
                                                <input type="time" name="txt_st" id="add" class="form-control" placeholder="" data-error="Please enter Address">
                                            </div>
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                End Time
                                                <input type="time" name="txt_et" id="add" class="form-control" placeholder="" data-error="Please enter Address">
                                            </div>
...
<?php
			...
			if(isset($_POST['submit']))
			{
				...
				$sql="insert into tbl_meeting
                values(null,'$d','$name','$add','$st','$et','$id',1)";
