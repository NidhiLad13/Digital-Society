                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="deposite-content">
                            <div class="diposite-box">
                                <h3>Notice</h3>
                                <span><a class="support-images" href="notice_add.php"><i class="fa fa-bell"></i></a></span>
                                <div class="deposite-table">
                                    ...
                                    <form method="post">
                                        ...
                                        where f.status=0 and w.Society_Id = $id" ;
                                        ...
                                        <tr>
                                          ...
                                          <td><?php echo $row['title'];?></td>
                                            ...
                                            <td>
                                            <a href="notice_del.php?id=<?php echo $nid ?>"class="btn btn-danger" > <i class="fa fa-trash"></i></a>
 </td>
                                      <?php  
                                      }
