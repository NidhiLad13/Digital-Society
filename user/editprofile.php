                        ...
                        <div class="row">
                            <div class="col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8 col-xs-12">
                                <div class="login-form signup-form">
                                    ...
                                    <?php
					include('conn.php');
					$sql="select * from tbl_rentholder where user_name='$id'";
							...
							?>
                                    <div class="row">
                                        <form id="contactForm" method="POST" class="log-form"  enctype="multipart/form-data" id="regiform">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <input type="number"  value="<?= $row['mobile_no']?>" name="txt_cn" id="number" class="form-control" placeholder="Contact no" data-error="Please enter your Contact">
                                            </div> 
                                            <div class="col-md-12 col-sm-12 col-xs-12">
...
<?php
			...
			//	$doj=$_POST['txt_doj'];
             //   $rid=$_POST['rid'];	
				...
				$sql="update tbl_rentholder set name= '$name',mobile_no=$con,email='$mail' where user_name='$id'";
                echo $sql;
