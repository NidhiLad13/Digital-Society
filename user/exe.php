                            ...
                            <div class="diposite-box">
                                ...
                                <div class="deposite-table">
                                    ...
                                    <form method="post">
                                        ...
                                        $sql="select * from tbl_expense as e join tbl_expensesoctety as s on
                                        s.expenses_id=e.expenses_id where society_id = $id;
                                       " ;
                                        ...
                                        ?>
                                        <tr>
                                           <td> <?php $nid= $row['Expenses_Id'];
                                           echo $nid;?> </td>
                                          <td><?php echo $row['Date'];?></td>
                                            <td><?php echo $row['Expenses_Title'];?></td>
                                            <td><?php echo $row['Description'];?></td>
                                            <td><?php echo $row['Amount'];?></td>
                                            <td><?php echo $row['amount_type']?></td>
                                            <td> <?php echo $row['amount_status']?>
                                        <?php if($row['amount_status']==0){
                                            echo "</br> <a href='#'> pay amount </a>";
                                        }
                                        else{
                                        echo "Amount Paid";}?></td>
