                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="deposite-content">
                            <div class="diposite-box">
                                <h3>Circular</h3>
                                <span><a class="support-images" href="cir_add.php"><i class="fa fa-file"></i></a></span>
                                    ...
                                    <form method="post">
                                        ...
                                        <tr>
                                          ...
                                          <td><?php echo $row['circular_title'];?></td>
                                            ...
                                            <td>
                                            <a href="cir_del.php?id=<?php echo $cid ?>"class="btn btn-danger" > <i class="fa fa-trash"></i></a>
 </td>
                                      <?php  
                                      }
                                      ?>
