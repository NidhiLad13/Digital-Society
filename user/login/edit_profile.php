	...
	<body>
			...
			<div class="inner">
				...
				<form method="post" enctype="multipart/form-data">
					...
					<div class="form-holder">
						...
						<input value="<?= $row['Admin_name']?>" type="text" class="form-control" placeholder="Enter Name" name="txt_name " >
					...
					<input value="<?= $row['Password']?>" type="password" class="form-control" placeholder="Password" name="txt_pass">
					</div>
		...
		<?php
			...
			if(isset($_POST['btn_sub']))
			{
				...
				$sql="update tbl_admin set values(null,'$name','$mail',$con,null,'$uid','$pass','$cdate','$bdate','$gender',null)";
