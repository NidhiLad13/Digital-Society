        ...
        <div class="login-area area-padding fix">
            ...
            <div class="table">
                <div class="table-cell">
                  ...
                  <li class="active"><a href="">Flat Holder</a></li>
                  <div class="col-md-3"></div>
                  <li class="active"><a href="rentholder.php">Rent Folder</a></li>
                                    <div class="row">
                                    
                                        <form id="contactForm" method="POST" class="log-form"  enctype="multipart/form-data" id="regiform">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <br>
                                                <input type="text" name="txt_name" id="name" class="form-control" placeholder="Your Full Name" data-error="Please enter your name" required>
                                            </div>
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <input type="text" name="txt_uname" id="uname" class="form-control" placeholder="Your user name" data-error="Please enter your name">
                                            </div>
                                            <div class="col-md-12 col-sm-12 col-xs-12">
...
<?php
			...
			if(isset($_POST['submit']))
			{
                ...
                if($pass==$cpass)
                {
				$sql="insert into tbl_flatholder values(null,'$name','$uname',$con,'$mail','$pass',null,'$doj','$rid','$fn','$fp','-1')";
