                    ...
                    <div class="row">
                        <div class=" col-md-8 col-sm-8 col-xs-12">
                            <div class="topbar-left">
                                <ul>
                                    <li><a href="#"><i class="fa fa-envelope"></i> jinaljariwala6868@gmail.com</a></li>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="topbar-right">
								<ul>
                                    ...
                                    <li><a href="user_login.php"><img src="img/icon/login.png" alt="">Login</a>
                                </ul>
							</div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 col-sm-9">
                                    <div class="header-right-link">
                                        <!-- search option end -->
                                        <a class="s-menu" href="user_login.php">Login</a>
                                    </div>
                                    <!-- mainmenu start -->
                                                ...
                                                <ul class="nav navbar-nav navbar-right">
                                                    ...
                                                    <li><a class="pages" href="#">Pages</a>
                                                        <ul class="sub-menu">
                                                            ...
                                                            <li><a href="user_regi.php">Register</a></li>
                                                        </ul>
                                                    </li>
							...
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="slide-all-text">
                                    ...
                                    <div class="layer-1 wow fadeInUp" data-wow-delay="0.3s">
                                        <h2 class="title2">Best Society Managment plan for worldwide</h2>
                                    </div>
                                    <!-- layer 2 -->
                                    <div class="layer-2 wow fadeInUp" data-wow-delay="0.5s">
                                        <p>We develop effective plans to maintain stability and activeness.</p>
                                    </div>
                                    <!-- layer 3 -->
                                    <div class="layer-3 wow fadeInUp" data-wow-delay="0.7s">
                                        <a href="user_login.php" class="ready-btn" >Get Started...</a>
                                    </div>
								</div>
							</div>
						</div>
                            ...
                            <div class="diposite-box">
                                ...
                                <div class="deposite-table">
                                    <table>
                                        ...
                                        <tr>
                                            <td><img src="img/icon/m.png" alt="">Arnold</td>
                                            <td>Jan 04, 2020</td>
                                            <td>$1000</td>
                                            <td>USD</td>
                                        </tr>
                                        <tr>
                                            <td><img src="img/icon/m1.png" alt="">Jhon Abra</td>
                                            <td>Jan 07, 2020</td>
                                            <td>$6000</td>
                                            <td>USD</td>
                                        </tr>
                                        <tr>
                                            <td><img src="img/icon/m2.png" alt="">Lanisha</td>
                                            <td>Jan 13, 2020</td>
                                            <td>$5000</td>
                                            <td>USD</td>
                                        </tr>
                                        <tr>
                                            <td><img src="img/icon/m3.png" alt="">Gongales</td>
                                            <td>Jan 12, 2020</td>
                                            <td>$2000</td>
                                            <td>USD</td>
                                        </tr>
                                        <tr>
                                            <td><img src="img/icon/m4.png" alt="">Admond sayhel</td>
                                            <td>Jan 10, 2020</td>
                                            <td>$1000</td>
                                            <td>USD</td>
                                        </tr>
                                        <tr>
                                            <td><img src="img/icon/m5.png" alt="">Remond</td>
                                            <td>Jan 02, 2020</td>
                                            <td>$3000</td>
                                            <td>USD</td>
                                        </tr>
                            ...
                            <div class="footer-content last-content">
                                <div class="footer-head">
                                    ...
                                    <div class="footer-contacts">
										...
										<p><span>Email :</span> info@resthyip4.com</p>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="copyright">
                                <p>
                                    Copyright © 2020
                                    <a href="#">Resthyip</a> All Rights Reserved
                                </p>
                            </div>
                        </div>
                    </div>
