	...
	<body>
			...
			<div class="inner">
				...
				<form method="post" enctype="multipart/form-data">
					...
					<div class="form-holder">
						...
						<input type="text" class="form-control" placeholder="Phone no" name="txt_mn" requried>
		...
		<?php
			...
			//	$sid=$_POST['sid'];
				...
				$sql="insert into tbl_admin values(null,'$name','$mail',$con,'$fn','$uid','$pass','$cdate','$bdate','$gender')";
