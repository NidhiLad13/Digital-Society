                    ...
                    <div class="navbar-header">
                        <a href="" class="navbar-brand">
                            ...
                            <div class="brand-title">
                                <span class="brand-text">MDS</span>
                            </div>
                        </a>
                    </div>
                    <!--================================-->
...
<div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">All Society Secretary will be display here</h3>
                            </div>
                            <div id="demo-custom-toolbar" class="table-toolbar-left">
                            <a href="login/add_sec.php" class="btn btn-success"> Add Secretary </a>    
                            </div>
                            <div class="panel-body">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <?php
                                                include("conn.php");
                                                    $query="Select * 
                                        from tbl_flatholder as f
                                        join tbl_flat as s 
                                        on f.flat_id=s.Flat_Id join tbl_wing as w on w.Wing_Id=s.Wing_Id
                                        join tbl_Society as p on w.Society_Id=p.Society_ID where f.roletype_id=2";
